		...
		<div class="col-md-6 jdl sembunyi">
			...
			<div class="alert alert-warning" style="box-shadow: 0 0 30px 1px grey;">
				<ul class="list-unstyled">
					...
					<li>6. Selamat menggunakan Sistem Informasi Bursa Kerja, Semoga dapat menemukan Tenaga kerja yang diinginkan!</li>
				</ul>
			</div>
		</div>

		<div class="col-md-6 bg-light lgn mlgn" style="box-shadow: 0 0 30px 1px grey;">
			<h3 class="text-secondary">Buat akun Perusahaan</h3>
			<br>
			<form action="<?php echo base_url() ?>akun/tambahkanComp" method="POST">
				<fieldset class="form-group">
					<label>Nama Perusahaan</label>
					<input type="text" class="form-control" name="namacomp" placeholder="Masukkan nama Perusahaan" required></input>
				</fieldset>
				<fieldset class="form-group">
					<label>Email</label>
			...
			<br>
			<p>Daftar Pencaker ?<a href="<?php echo base_url() ?>akun/reg_pencaker"> Daftar</a></p>
