...
<ol class="breadcrumb">
    ...
    <h6 class="breadcrumb-item active"></i>Lowongan</h6>
</ol>
<!-- DataTables Example -->
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <button type="submit" formaction="<?php echo base_url() ?>admin/matikanLowongan" formmethod="POST" class="btn btn-danger btnmob btn-sm" style="margin-bottom: 5px;">
      ...
      <table class="table table-hover" style="width: 100%">
        ...
        <tbody>
          ...
          <tr class="text-center">
            ...
            <td>
              <a href="<?=base_url()?>admin/detailLow/<?=$a->ID_LOWONGAN;?>"><?php echo $a->JUDUL; ?></a>
            </td>
