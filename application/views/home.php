   ...
   <?php 
    ...
    <div class="container" style="padding-top: 25px;">
      <div class="row">
        ...
        <div class="col-md-9 bg-light sembunyi">
          <?php echo $slider; ?>
                ...
                <div class="col-md-3">
                  <div class="card alert alert-info" style="box-shadow: 0 0 10px 1px black;">
                    <div class="card-body text-center">
                      ...
                      <h1 class="text-primary">
                        <?php if($smp[0]->total==''){echo "0";}else{ echo $smp[0]->total;}; ?></h1></h1>
                      <p>Kuota lowongan</p>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-md-3"  style="padding-top: 30px;">
          <div class="card">
            ...
            <div class="card-body bg-light">
              ...
              <br>
              <form action="<?=base_url('akun/masuk');?>" method="post">
              ...
              <br>
              <p>Belum mempunyai akun ?<a href="<?php echo base_url() ?>akun/reg_pencaker"> Daftar Pencaker</a>, <a href="<?php echo base_url() ?>akun/reg_comp"> Daftar Perusahaan</a></p>
